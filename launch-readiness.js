...
const checks = [
  ...
  ['Stripe plan prices', ['STRIPE_PRICE_STARTER','STRIPE_PRICE_GROWTH','STRIPE_PRICE_PRO','STRIPE_PRICE_STARTER_ANNUAL','STRIPE_PRICE_GROWTH_ANNUAL','STRIPE_PRICE_PRO_ANNUAL'].every(key => process.env[key]), 'all monthly and annual STRIPE_PRICE_* values'],
